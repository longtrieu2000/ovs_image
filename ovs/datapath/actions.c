...
/* Cap phat FIFO hanh dong va flow_keys per-CPU. */
int action_fifos_init(void)
{
	/* Cap phat mang FIFO per-CPU. */
	action_fifos = alloc_percpu(struct action_fifo);
	if (!action_fifos)
		return -ENOMEM;

	/* Cap phat flow_keys per-CPU; neu loi thi giai phong FIFO. */
...
/* Giai phong cac vung per-CPU cho FIFO va flow_keys. */
